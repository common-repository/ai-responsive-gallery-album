...
$ai_check_photos_nonce= (isset($_REQUEST['_wpnonce'])) ? $_REQUEST['_wpnonce'] :  '';
...
<table class="form-table">
  ...
  $ai_photo_title = (isset($ai_photo_res[0]['photo_title']) ? $ai_photo_res[0]['photo_title'] : '');
  $photo_visible = (isset($ai_photo_res[0]['photo_visible']) ? $ai_photo_res[0]['photo_visible'] : '');
  ?>
   ...
   <input type="hidden" name="_wpnonce" value="<?php echo esc_attr($ai_photo_nonce);?>"/>
    ...
    <tr>
      ...
      <td><input type="text" style="text-align:left;" value="<?php echo esc_attr($ai_photo_title); ?>" maxlength="16" size="50" name="photo_title" id="photo_title" class="required"></td>
    ...
    <tr>
      ...
      <td>
	   ...
	   <?php 
	   $photo_file_thumb = (isset($photo_file_thumb) ? $photo_file_thumb : '');
	   $thub_photo_name = (isset($thub_photo_name) ? $thub_photo_name : '');
	   $ai_photo_url = esc_url($photo_file_thumb.$thub_photo_name) ; ?>
    ...
    <tr>
      ...
      <td>
       ...
       foreach($ai_photo_visible as $ai_k=>$ai_v){?>
            ...
            <option value="<?php echo esc_attr($ai_v); ?>" <?php selected( $ai_v,$photo_visible );?> ><?php echo $ai_k; ?></option>
