...
$ai_check_album_nonce = (isset($_REQUEST['_wpnonce']) ? $_REQUEST['_wpnonce'] : '');
		...
		<div class="inside">
			<form method="post" name="frmnewalbum" id="frmnewalbum" enctype="multipart/form-data">
				<table class="form-table">
					...
					$ai_album_title = (isset($ai_edit_res[0]['album_title']) ? $ai_edit_res[0]['album_title'] : '');
					$album_visible = (isset($ai_edit_res[0]['album_visible']) ? $ai_edit_res[0]['album_visible'] : '');
					$ai_file_thumb = (isset($ai_file_thumb) ? $ai_file_thumb : '');
					$thub_album_name  = (isset($thub_album_name ) ? $thub_album_name  : '');
					?>
					...
					<tr>
						...
						<td><input type="text" style="text-align:left;" value="<?php echo esc_attr($ai_album_title); ?>" maxlength="16" size="50" name="album_title" id="album_title" class="required"></td>
					</tr>
					<tr>
						...
						<td>
							...
							<select name="album_visible" id="album_visible">
								<?php foreach($ai_visible as $ai_k=>$ai_v){ ?>
									<option value="<?php echo esc_attr($ai_v); ?>" <?php selected( $ai_v, $album_visible);?> ><?php echo $ai_k; ?></option>
								<?php } ?>
							</select>
						</td>
					</tr>
